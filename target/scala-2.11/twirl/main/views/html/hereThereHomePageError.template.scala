...
import play.twirl.api.TemplateMagic._
     ...
     object hereThereHomePageError_Scope0 {
import models._
...
import play.mvc.Http.Context.Implicit._
     ...
     object hereThereHomePageError_Scope1 {
import service.UserProvider

class hereThereHomePageError extends BaseScalaTemplate[play.twirl.api.HtmlFormat.Appendable,Format[play.twirl.api.HtmlFormat.Appendable]](play.twirl.api.HtmlFormat) with play.twirl.api.Template2[UserProvider,String,play.twirl.api.HtmlFormat.Appendable] {
...
"""),format.raw/*7.1*/("""<style type="text/css">
  ...
  """),format.raw/*17.3*/("""#child_div_2"""),format.raw/*17.15*/("""{"""),format.raw/*17.16*/("""
    """),format.raw/*18.5*/("""float:left;
    margin-right:15px;
  """),format.raw/*20.3*/("""}"""),format.raw/*20.4*/("""
"""),format.raw/*21.1*/("""</style>
<link rel="stylesheet" href=""""),_display_(/*22.31*/routes/*22.37*/.Assets.versioned("lib/bootstrap/css/bootstrap.css")),format.raw/*22.89*/("""">
<link href=""""),_display_(/*23.14*/routes/*23.20*/.Assets.versioned("css/main.css")),format.raw/*23.53*/("""" rel="stylesheet">
...
<div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1" >
  <ul class="nav navbar-nav" style="background-color:#E0FDF7 ">
   ...
   <div class="jumbotron" id='parent_div_1' style="background-color: #FAEEAF ;width: 100%;padding-top: 5px;padding-bottom: 10px;margin-bottom: 10px">
  <div class="child_div_1" style="background-color: #FB2773  ;border-radius: 10px;margin: 1px;">
            <form action="getAllOrderId" style="margin: 2px; position: all;">
              <h4 style="color: white"><b>"""),_display_(/*36.44*/message),format.raw/*36.51*/("""</b></h4>
            </form>
          </div>
        <div id='parent_div_1'>
...
/**/
object hereThereHomePageError extends hereThereHomePageError_Scope0.hereThereHomePageError_Scope1.hereThereHomePageError
              /*
                  -- GENERATED --
                  DATE: Sun Apr 16 04:44:12 IST 2017
                  SOURCE: /home/amit/workspaceTest/play-authenticate-master/samples/java/play-authenticate-usage/app/views/hereThereHomePageError.scala.html
                  HASH: c8b182f3475440dde9ff378a09341b43c778792e
                  MATRIX: 865->30|1007->77|1037->82|1105->142|1144->144|1171->145|1278->224|1307->225|1339->230|1380->244|1408->245|1438->248|1478->260|1507->261|1539->266|1603->303|1631->304|1661->307|1701->319|1730->320|1762->325|1826->362|1854->363|1882->364|1948->403|1963->409|2036->461|2079->477|2094->483|2148->516|3005->1346|3033->1353
                  LINES: 30->2|35->2|39->6|39->6|39->6|40->7|43->10|43->10|44->11|45->12|45->12|46->13|46->13|46->13|47->14|49->16|49->16|50->17|50->17|50->17|51->18|53->20|53->20|54->21|55->22|55->22|55->22|56->23|56->23|56->23|69->36|69->36
                  -- GENERATED --
              */
